export const ingenieriaFerroviariaData = {
  "¿Qué es la Ingeniería Ferroviaria?":
    "La Ingeniería Ferroviaria (IF) forma profesionales especializados en el diseño, operación y mantenimiento de sistemas ferroviarios.\n\n" +
    "🎯 Perfil de Egreso:\n" +
  ...
  "¿Cuál es el campo laboral de IF?":
    "Los egresados de IF pueden trabajar en:\n\n" +
