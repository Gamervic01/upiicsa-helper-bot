export const ingenieriaTransporteData = {
  "¿Qué es la Ingeniería en Transporte?":
    "La Ingeniería en Transporte (IT) forma profesionales especializados en la planificación, diseño y operación de sistemas de transporte.\n\n" +
    "🎯 Perfil de Egreso:\n" +
  ...
  "¿Cuál es el campo laboral de IT?":
    "Los egresados de IT pueden trabajar en:\n\n" +
    "🚌 Transporte Público:\n" +
