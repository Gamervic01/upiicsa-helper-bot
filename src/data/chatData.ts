export const TODAS_LAS_PREGUNTAS = {
  ...
  "¿Cómo inicio mi trámite de titulación?":
    "Para iniciar tu trámite de titulación necesitas:\n1) Certificado de servicio social liberado\n2) Kardex al 100%\n3) Constancia de no adeudo\n4) Acreditación del idioma inglés\n\nVisita: <a href='https://www.upiicsa.ipn.mx/estudiantes/titulacion.html' target='_blank' rel='noopener noreferrer' class='text-blue-500 hover:text-blue-700 underline'>www.upiicsa.ipn.mx/estudiantes/titulacion.html</a>",
  "¿Dónde encuentro mi horario de clases?":
    "Puedes consultar tu horario en el SAES: <a href='https://saes.upiicsa.ipn.mx' target='_blank' rel='noopener noreferrer' class='text-blue-500 hover:text-blue-700 underline'>saes.upiicsa.ipn.mx</a> con tu usuario y contraseña en la sección 'Horario'.",
  ...
  "¿Cuál es el proceso de reinscripción?":
    "La reinscripción se realiza en SAES según el calendario oficial. Pasos: 1) Verifica tu fecha, 2) Realiza el pago, 3) Selecciona materias, 4) Imprime tu comprobante. Fechas en: <a href='https://www.upiicsa.ipn.mx/estudiantes/calendario.html' target='_blank' rel='noopener noreferrer' class='text-blue-500 hover:text-blue-700 underline'>www.upiicsa.ipn.mx/estudiantes/calendario.html</a>",
